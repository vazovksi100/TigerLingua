...
class ViewController: UIViewController, URLSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        animationView.animation = .named("tiger")
    ...
    func MainView() {
        ...
        let homeViewController = UIHostingController(rootView: TigerLingua.TabMainView())
    ...
    func sendToRequest() {
        let url = URL(string: "https://TigerLingua.shop/starting")
